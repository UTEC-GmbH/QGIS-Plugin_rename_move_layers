...
from .modules.constants import PLUGIN_DIR
...
class UTECLayerTools(QObject):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, iface: QgisInterface) -> None:
        ...
        self.icon_path: str = str(self.plugin_dir / "icon.svg")
    ...
    def initGui(self) -> None:  # noqa: N802
        ...
        rename_action = self.add_action(
            icon_path=str(self.plugin_dir / "icons" / "main_rename.svg"),
            button_text=button,
        ...
        undo_rename_action = self.add_action(
            icon_path=str(self.plugin_dir / "icons" / "main_undo.svg"),
            button_text=button,
        ...
        move_action = self.add_action(
            icon_path=str(self.plugin_dir / "icons" / "main_move.svg"),
            button_text=button,
        ...
        rename_move_action = self.add_action(
            icon_path=str(self.plugin_dir / "icons" / "main_rename_move.svg"),
            button_text=button,
