...
from .resource_utils import get_icon
...
class LayerLocation(LayerLocationInfo, Enum):
    ...
    CLOUD = (
        get_icon("icons/location_cloud.svg"),
    ...
    EMPTY = (
        get_icon("icons/location_empty.svg"),
    ...
    EXTERNAL = (
        get_icon("icons/location_external.svg"),
    ...
    FOLDER_NO_GPKG = (
        get_icon("icons/location_folder_no_gpkg.svg"),
    ...
    GPKG_FOLDER = (
        get_icon("icons/location_gpkg_folder.svg"),
    ...
    GPKG_PROJECT = (
        get_icon("icons/location_gpkg_project.svg"),
    ...
    UNKNOWN = (
        get_icon("icons/location_unknown.svg"),
